...
module.exports = function (app) {
  app.post(
    "/test/api/v1/vehicletype/",
    [upload.single("file")],
    vehicleTypeController.addVehicleType
  );
  // app.get("/test/api/v1/vehicletype/",[],vehicleTypeController.getAllVehicle)
  app.get(
    "/test/api/v1/vehicletype/filter/",
    [],
    vehicleTypeController.filterVehicleType
  );
  app.delete(
    "/test/api/v1/vehicletype/:id",
    [],
  ...
  app.get(
    "/test/api/v1/vehicletype/",
    [],
    vehicleTypeController.getAllVehicleType
  );
  app.get(
    "/test/api/v1/runMode/vehicleType",
