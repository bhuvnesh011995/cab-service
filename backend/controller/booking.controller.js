...
exports.addBooking = async function (req, res, next) {
  try {
    ...
    let countryDoc = await db.country
      .findOne({ name: bookingInfo.country })
      .populate({
        path: "state",
        model: "State",
