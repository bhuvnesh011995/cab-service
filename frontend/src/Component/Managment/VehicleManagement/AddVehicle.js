...
const [vehicle,setVehicle] = useState({...initialState,driverEmail:state.email});
    ...
    <Text_Input
      ...
      <label class="form-label">
        ...
        <input class="form-control"
          ...
          onChange={(e)=>setVehicle(preVal=>({...preVal,year:e.target.value}))}
        /></div>
        <Selection_Input
        ...
        <div class="m-3">
                  <input
                  onChange={e=>setVehicle(preVal=>({...preVal,verified:e.target.checked}))}
      ...
      <label class="form-label">
        ...
        <input class=" m-2 form-control" onChange={e=>setVehicle(preVal=>({...preVal,registration:{...preVal.registration,number:e.target.value}}))}
          type="text"
    ...
    <div class="m-3">
      <label class="form-label">
        ...
        <input class=" m-2 form-control" onChange={e=>setVehicle(preVal=>({...preVal,registration:{...preVal.registration,expiryDate:e.target.value}}))}
          type="date"
        />
    </div><div class="m-3">
                  <input
                  onChange={e=>setVehicle(preVal=>({...preVal,registration:{...preVal.registration,verified:e.target.checked}}))}
                    class="form-check-input"
                    type="checkbox"
                  /><label class="form-check-label">Verify</label>
                </div>
                  ...
                  <div class="m-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setVehicle((preVal) => ({
                          ...preVal,
                          insurance: { ...preVal.insurance, expiryDate: e.target.value },
                        }))
                      }
                      type="date"
                  ...
                  <div class="m-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setVehicle((preVal) => ({
                          ...preVal,
                          permit: { ...preVal.permit, expiryDate: e.target.value },
                        }))
                      }
                      type="date"
                      placeholder="Enter expiry Date"
                  ...
                  <div class="m-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setVehicle((preVal) => ({
                          ...preVal,
                          pollutionCertificate: { ...preVal.pollutionCertificate, expiryDate: e.target.value },
                        }))
                      }
                      type="date"
                      placeholder="Enter expiry Date"
