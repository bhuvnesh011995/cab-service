  ...
  useEffect(() => {
    ...
    if (vehicle?.registration) {
      arr.push({
        ...
        verified: vehicle?.registration?.verified ? (
          <tiIcons.TiTick />
        ) : (
          <rsIcons.RxCross2 />
        ),
    ...
    if (vehicle?.insurance) {
      arr.push({
        ...
        verified: vehicle?.insurance?.verified ? (
          <tiIcons.TiTick />
        ) : (
          <rsIcons.RxCross2 />
        ),
    ...
    if (vehicle?.permit) {
      arr.push({
        ...
        verified: vehicle?.permit?.verified ? (
          <tiIcons.TiTick />
        ) : (
          <rsIcons.RxCross2 />
        ),
    ...
    if (vehicle?.pollutionCertificate) {
      arr.push({
        ...
        verified: vehicle?.pollutionCertificate?.verified ? (
          <tiIcons.TiTick />
        ) : (
          <rsIcons.RxCross2 />
        ),
